...
Fügen Sie bei jeder dargestellten Notiz einen \texttt{Löschen}-Button hinzu.
...
Anforderungen:
\begin{itemize}
    \item Endpoint: \texttt{/api/collections/notes/records/:id}
...
\begin{itemize}
    ...
    \item oder gelöschtes Element direkt aus dem DOM entfernen
\end{itemize}
...
\begin{itemize}
    ...
    \item Bestätigungsdialog vor dem Löschen
