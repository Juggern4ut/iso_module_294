...
Dieses Objekt soll anschliessend an einen Server gesendet werden.
...
\section{Mini-Projekt: Fetch-Testseite}

Erstellen Sie eine kleine Testseite mit folgenden Elementen:
\begin{itemize}
    \item Ein Button zum Laden von Daten (GET)
    \item Ein Button zum Senden von Daten (POST)
    \item Ein Ausgabebereich im DOM
\end{itemize}

Beim Klicken auf die Buttons sollen die entsprechenden Fetch-Anfragen ausgeführt und die Resultate im Browser angezeigt werden.

Achten Sie auf saubere Struktur und verständliche Variablennamen.

\section{Optional: Erweiterung}

Erweitern Sie die Anwendung optional um folgende Punkte:
\begin{itemize}
    \item Anzeige von Ladezustand (z.\,B.\ \glqq Lade Daten...\grqq)
    \item Anzeige von Fehlermeldungen im DOM statt in der Konsole
\end{itemize}
