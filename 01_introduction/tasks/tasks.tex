...
Da JavaScript nativ in jedem modernen Browser ausgeführt werden kann, ist keine Installation einer Runtime notwendig. Um den Code optimal zu bearbeiten, sollten Sie jedoch eine IDE oder einen simplen Code-Editor installiert haben.
